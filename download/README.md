...
##   -k, --taskname string   task ID (default is random). (default "73f8348b-96be-4e39-9ad9-1960fc203355")
...
##       --temp-code string      task tempcode. (default "RCgiSgj")
...
##       --proxy string      HTTP proxy to query.
##       --save-log          Save log to file.
##   -k, --taskname string   task ID (default is random). (default "4803f6e5-0864-4871-aa50-09507624eab2")
##       --timeout int       set the timeout of per request. (default 35)
##       --verbose int       verbose level (0:no output, 1: basic level, 2: with env info) (default 1)
```
